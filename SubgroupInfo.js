...
var group : XMLGroup;
var graphicContext : DisplayDiagram;
...
function showSubgroupLattice ( type /*: ?string */ ) {
   ...
   function pathsUpFrom ( H /*: DecoratedSubgroup */) {
      H._used = true;
...
function showQuotientSheet ( indexOfN /*: number */, type /*: ?string */) {
