...
declare class THREE_Scene extends THREE.Object3D {
   constructor() : void;
   add(group: THREE.Group) : THREE.Scene;
   fog: THREE.Fog;
   children: any;
}
...
declare class THREE_ArrowHelper {
   constructor(dir: THREE.Vector3, origin: THREE.Vector3, length: number, color: number |  string, headLength: number, headWidth: number) : void;
}
