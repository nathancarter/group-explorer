declare module "https://cdn.jsdelivr.net/npm/three@0.110.0/build/three.module.js" {
   ...
   declare class Line extends Object3D {
      constructor(geometry: Geometry, material: Material): void;
      geometry: Geometry;
      isLine: boolean;
      material: Material;
   }
...
declare module "https://cdn.jsdelivr.net/npm/three@0.110.0/examples/jsm/controls/TrackballControls.js" {
    declare class TrackballControls {
